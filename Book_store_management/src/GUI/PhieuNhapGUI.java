...
public class PhieuNhapGUI extends javax.swing.JPanel {
    ...
    public PhieuNhapGUI() {
        ...
        columnModel.getColumn(1).setPreferredWidth(140); // Độ rộng cột 1
        columnModel.getColumn(2).setPreferredWidth(140); // Độ rộng cột 2
        columnModel.getColumn(3).setPreferredWidth(140); // Độ rộng cột 3
        columnModel.getColumn(4).setPreferredWidth(140); // Độ rộng cột 4
